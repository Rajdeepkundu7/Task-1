...
data
ndat=data.frame(x=9.25)            #For given value of study time
x=data$Hours
y=data$Scores                         #Defining the Variables 
mod=lm(y~x)                         #Defining the linear model 
summary(mod)                        #Summary of the linear model
predict.lm(mod,ndat)                #Predicting the score value for the given study hour
...
resi=stdres(mod)                     #Obtaining the Residual values from the linear model
